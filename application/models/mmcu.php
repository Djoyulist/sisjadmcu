...
class Mmcu extends CI_Model{
	...
	function getListUndangan(){
		$sqlstr = 'select agt.id_anggota, nip, nama_anggota, bagian, jabatan, CONCAT(DATE_FORMAT(DATE_SUB(DATE(tgl_lahir), INTERVAL 7 DAY), "%d-%m-"),YEAR(NOW())) as tgl_mcu, DAYNAME(DATE_SUB(DATE(tgl_lahir), INTERVAL 7 DAY)) as nama_tgl, mcu.process_status, agt.type_checkup ';
